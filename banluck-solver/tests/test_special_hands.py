...
class TestHandHierarchyRank:
    def test_ban_ban_is_strongest(self):
        ...
        for other in [HAND_BAN_LUCK, HAND_777, HAND_FIVE_CARD_21,
                      HAND_FIVE_CARD_SUB21, HAND_REGULAR, HAND_BUST]:
            assert ban_ban_rank < hand_hierarchy_rank(other)

    def test_hierarchy_order(self):
        order = [HAND_BAN_BAN, HAND_BAN_LUCK, HAND_777, HAND_FIVE_CARD_21,
                 HAND_FIVE_CARD_SUB21, HAND_REGULAR, HAND_BUST]
